    ...
    <div className='def-padding'>
      <div className='flex justify-between items-center md:gap-16 md:w-6/12 w-11/12 m-auto text-primary uppercase'>
        <div className='flex flex-col items-center basis-1/3 w-3/12'>
            <Image src={"https://i.imgur.com/jLBCo6c.png"} width={50} height={100} alt='Remote Control' className='lg:w-2/12 w-3/12'/>
            <p className='text-sm md:text-xl mt-4'>{lang.home?.banner?.remote ?? 'Remote'}</p>

        </div>
        <div className='flex flex-col items-center basis-1/3'>
            <Image src={'https://i.imgur.com/82KO5Qa.png'} width={50} height={100} alt='Switch'className='lg:w-4/12 w-3/12'/>
            <p className='text-sm md:text-xl mt-4'>{lang.home?.banner?.switch ?? "Switch"}</p>

        </div>
        <div className='flex flex-col items-center basis-1/3'>
            <Image src={"https://i.imgur.com/jOzvCgt.png"} width={100} height={100} alt='Mobile Phone' className='lg:w-4/12 w-3/12'/>
            <p className='text-sm md:text-xl mt-4'>{lang.home?.banner?.mobile ?? "Mobile"}</p>

        </div>
      </div>
      <div className='md:w-8/12 w-11/12 m-auto flex md:flex-row flex-col items-center justify-between def-padding gap-10'>
