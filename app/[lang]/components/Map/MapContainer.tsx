        ...
        <div className='flex flex-col items-center justify-between gap-4 lg:flex-row'>
          <div className='flex basis-full flex-row flex-wrap items-center justify-center gap-4 px-4 md:px-20 lg:basis-1/3 lg:flex-col'>
            {locations.map(location => (
              ...
              type='button'
                ...
                key={location.lat}
                className='image-tinter relative w-full rounded-md border-2 border-custom p-4 text-left transition-transform delay-75 duration-100 ease-in-out hover:scale-105 md:w-60'
                onClick={() => {
          ...
          <div className='basis-full lg:basis-2/3'>
            <MapContainer
              ...
              zoom={7}
              style={{ height: '600px' }}
              className='map-container z-10 rounded-md border-2 border-custom'
            >
